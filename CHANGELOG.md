...
- **PWA instalable:** íconos reales (192/512 + *maskable* para Android + apple-touch
  para iOS, generados con `npm run icons`), manifiesto completo (id, scope, lang,
  orientación, categorías) y metadatos iOS. Botón **"📲 Instalar"** en la barra que
  dispara el prompt de instalación (`src/hooks/usePwaInstall.js`).
